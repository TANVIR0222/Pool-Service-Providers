        ...
        >
          ...
          <View style={tw` flex-col  gap-6`}>
            ...
            <View style={tw` flex-col items-center gap-4`}>
              ...
              <Text
                style={tw`text-secondary_button_color text-center text-base font-roboto-400`}
              >
                Your payment complete successfully.
              </Text>
            </View>
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                router.push("/home-owner/review-and-rating/review-and-rating");
                handleClose;
              }}
            >
